...
- Creación de la infraestructura por medio de Azure.
    1. [Implementación.](https://github.com/sapuertaf/AzureInfraestructure#1-implementaci%C3%B3n)
    2. [Recursos usados y explicación.](https://github.com/sapuertaf/AzureInfraestructure#2-recursos-usados-y-explicaci%C3%B3n)
    3. [Video explicativo.](https://github.com/sapuertaf/AzureInfraestructure#3-video-explicativo) 
    - [Código implementado para la solución.](https://github.com/sapuertaf/AzureInfraestructure#c%C3%B3digo-implementado-para-la-soluci%C3%B3n)
        1. [Variables globales a ser usadas en el programa.](https://github.com/sapuertaf/AzureInfraestructure#1-variables-globales-a-ser-usadas-en-el-programa)
        2. [Configuración de los puntos de montaje.](https://github.com/sapuertaf/AzureInfraestructure#2-configuraci%C3%B3n-de-los-puntos-de-montaje)
        3. [Importación de librerías y creación del esquema de datos.](https://github.com/sapuertaf/AzureInfraestructure#3-importaci%C3%B3n-de-librer%C3%ADas-y-creaci%C3%B3n-del-esquema-de-datos)
        4. [Extracción y transformación de los datos](https://github.com/sapuertaf/AzureInfraestructure#4-extracci%C3%B3n-y-transformaci%C3%B3n-de-los-datos)
        5. [Carga de los datos en las capas raw y silver.](https://github.com/sapuertaf/AzureInfraestructure#5-carga-de-datos-en-las-capas-raw-y-silver)
        6. [Detener procesos de spark streaming.](https://github.com/sapuertaf/AzureInfraestructure#6-detener-procesos-de-spark-streaming)
